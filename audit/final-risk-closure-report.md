...
- Phase-2 hardening adds deterministic engine/provider attempt traceability and explicit external runtime validation (`ENGINE_RUNTIME_VALIDATED|INVALID`, `PROVIDER_ATTEMPT_*`) with Python runtime contract enforcement (`LV_PDF_ENGINE_REQUIRED_PYTHON=3.12` by default).
